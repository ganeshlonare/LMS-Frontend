...
const Denied = () => {
  ...
  return (
    <main className="h-screen w-full flex flex-col justify-center items-center bg-base-200 text-base-content">
      <h1 className="text-9xl font-extrabold tracking-widest">
        403
      </h1>
      <div className="bg-base-300 px-2 text-sm rounded rotate-12 absolute">
        Access Denied
      </div>
      <button className="mt-5">
        <a className="relative inline-block text-sm font-medium text-[#FF6A3D] group active:text-yellow-500 focus:outline-none focus:ring">
          ...
          <span
            onClick={() => navigate(-1)}
            className="relative block px-8 py-3 bg-base-100 border border-current"
          >
            Go Back
          </span>
        </a>
