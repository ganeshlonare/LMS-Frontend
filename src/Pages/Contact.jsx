...
const Contact = () => {
  ...
  return (
    <Layout>
      <div className="flex items-center justify-center h-[100vh] text-base-content">
        <form
          onSubmit={handleFormSubmit}
          className="flex flex-col items-center justify-center gap-2 p-5 rounded-md text-base-content shadow-[0_0_10px_black] w-[22rem] bg-base-100"
        >
